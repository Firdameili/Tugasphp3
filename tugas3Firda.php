...
<html lang="en">
  ...
  <body>
    <?php
    $mhs1 = ["nim" => "001", "nama" => "Fida", "nilai" => 75];
    $mhs2 = ["nim" => "002", "nama" => "Fia", "nilai" => 60];
    $mhs3 = ["nim" => "003", "nama" => "Fira", "nilai" => 55];
    $mhs4 = ["nim" => "004", "nama" => "Frd", "nilai" => 80];
    $mhs5 = ["nim" => "005", "nama" => "Firda", "nilai" => 95];
    $mhs6 = ["nim" => "006", "nama" => "Frda", "nilai" => 65];
    $mhs7 = ["nim" => "007", "nama" => "Fird", "nilai" => 85];
    $mhs8 = ["nim" => "008", "nama" => "Fi", "nilai" => 40];
    $mhs9 = ["nim" => "009", "nama" => "Fa", "nilai" => 85];
    $mhs10 = ["nim" => "010", "nama" => "Fia", "nilai" => 70];
